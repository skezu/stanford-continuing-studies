...
<!-- _backgroundImage : url('bkg/Template-Background-stanford/Intro.png') -->
...
<!-- _backgroundImage : url('bkg/Template-Background-stanford/TopBand.png') -->
...
<!-- _backgroundImage : url('bkg/Template-Background-stanford/Intermediate.png') -->
...
<!-- _backgroundImage : url('bkg/Template-Background-stanford/RightBand.png') -->
...
<!-- _backgroundImage : url('bkg/Template-Background-stanford/Closer.png') -->
# Thank You!  
